...
```bash
conda env create --file https://raw.githubusercontent.com/maawoo/gedixr/v0.7.1/environment.yml
conda activate gedixr_env
pip install "gedixr @ git+https://github.com/maawoo/gedixr.git@v0.7.1"
```
